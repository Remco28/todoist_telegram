...
class LLMAdapter:
    ...
    def _normalize_turn_payload(payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(view_name, str):
            ...
            if normalized_view in {"today", "due_today", "focus", "urgent", "open_tasks"}:
    ...
    async def interpret_telegram_turn(self, message: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        prompt = (
            ...
            "view_name may be omitted or one of: today, due_today, focus, urgent, open_tasks.\n"
            ...
            "Use today for today's agenda, due_today when the user explicitly asks what is due today or what remains due today, urgent for high-priority items, open_tasks for listing currently open tasks, and focus only if the user explicitly asks for top priorities.\n"
